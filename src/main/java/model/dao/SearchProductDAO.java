...
public class SearchProductDAO extends BaseDAO {
	...
	public ArrayList<HangHoa> getDsHangHoa(String searchText) {
		...
		String sql = "SELECT * FROM HangHoa WHERE MaHH LIKE ? OR TenHH LIKE ? OR donvitinh LIKE ? OR ghichu LIKE ? OR DonGiaThamKhao=?";
	...
	public int getTotalPageNumber(String searchText) {
		Connection connection = getConnection();
		String sql = "SELECT count(tenhh) as tongsodong FROM HangHoa WHERE MaHH LIKE ? OR TenHH LIKE ?"
				+ " OR donvitinh LIKE ? OR ghichu LIKE ? OR DonGiaThamKhao = ?";
		PreparedStatement pstmt = null;
        ResultSet rs = null;
	...
	public ArrayList<HangHoa> getDsHangHoa(String searchText, int pageNumber) {
        ...
        String sql = "SELECT * FROM (SELECT RowNum = ROW_NUMBER() OVER (ORDER BY mahh), * FROM HangHoa"
        		+ " WHERE MaHH LIKE ? OR TenHH LIKE ? OR donvitinh LIKE ? OR ghichu LIKE ? OR DonGiaThamKhao = ?)"
